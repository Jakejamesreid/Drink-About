describe("My whatCanIDrink function", function() {
    ...
    describe("Checks age", function(){
        ...
        it("should be unable to return a drink when called with a string", function(){
            expect(whatCanIDrink("Hi")).toBe("Sorry. I can’t tell what drink because that age is incorrect!");
        });
